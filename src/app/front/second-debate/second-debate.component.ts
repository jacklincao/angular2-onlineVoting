...
@Component({
  selector: 'app-second-debate',
  templateUrl: './second-debate.component.html',
  styleUrls: ['./second-debate.component.css']
})
export class SecondDebateComponent implements OnInit {
  ...
  public next(): void {
    this.router.navigate(['../thirddebate'], {relativeTo: this.acitverouter});
  }
}
